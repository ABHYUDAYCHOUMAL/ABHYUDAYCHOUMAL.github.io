...
export const bio = {
  short:
    "I'm a backend developer and architect at NirJai Technologies. I lead architectural restructures, design integrations against tight demos, and ramp on unfamiliar stacks fast — Deluge zero-to-production in three months, SwiftUI zero-to-App-Store in five weeks, a deep FastAPI codebase from catch-up to architectural ownership in six.",
  long:
...
export const career: CareerEntry[] = [
  {
    ...
    bullets: [
      "Quanted Query — backend architect on a financial analytics platform. Led a thirteen-phase restructure of an 18,000+ line FastAPI monolith into a domain-driven architecture with re-exporting shims, centralized exception hierarchy, and a feature-flagged Neo4j cache — zero downtime, zero regression. Owned the ReBAC migration (Zanzibar / OpenFGA) for the B2C→B2B pivot, including a sixteen-section enterprise architecture plan that became the team's shared reference.",
      "Aztute — tech lead on three of four enterprise integrations into a live Angular/.NET/SQL Server healthcare platform: DocuSign, sFax (after three vendor cycles), and bidirectional Outlook/Teams calendar sync via Microsoft Graph with idempotent event writes, delta tokens, and conflict resolution. Three of four integrations live for the CEO demo on a 23-day window.",
      ...
      "Navstar Shipping (USA) — owned a Zoho Creator/Deluge build replacing ten months of specialist work in 3.5. FedEx-native OAuth lifecycle with refresh-on-401, rate-shopping across Ground/Express/International, seven-state pickup status machine, GlobalTrade customs handling, webhook with signature validation. 1,000+ FedEx API references across 18 custom functions; an 11-role × 41-form RBAC matrix.",
    ],
    tech: [
      "FastAPI",
      "Swift",
...
export const projects: Project[] = [
  {
    ...
    description:
      "Backend architect on an AI-driven market exploration platform. Led a thirteen-phase restructure of an 18,000-line FastAPI monolith into a domain-driven architecture — zero downtime, zero regression. Owned the ReBAC migration (Zanzibar / OpenFGA) for the B2C→B2B pivot, on top of a Neo4j-cached LLM pipeline with three-state prompt resolution.",
  ...
  },
  {
    ...
    description:
      "First iOS app shipped to the App Store. Production controller-companion app for an Indian hardware founder — SwiftUI/MVVM, GameController framework, two-tier NSCache+disk caching with background prefetch. Built from zero in five weeks: 70% faster loads, 80% fewer API calls.",
...
export const skillBuckets: SkillBucket[] = [
  {
    title: "Architect",
    tagline: "Systems · Backend · Restructures",
    description:
  ...
  {
    title: "Builder",
    tagline: "Integrations · Mobile · Cross-stack",
    description:
